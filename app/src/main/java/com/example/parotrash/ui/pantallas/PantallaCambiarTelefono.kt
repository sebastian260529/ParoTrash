...
fun PantallaCambiarTelefono(
    ...
    Column(
        ...
        Text(
            text = "Ingresa un número de teléfono valido y actualizado.",
            fontSize = 14.sp,
...
@Composable
fun PreviewPantallaCambiarTelefono() {
    ParoTrashTheme() {
        PantallaCambiarTelefono(
            irAHome = {},
            irAConfiguracion = {},
            irARegistroExitoso = {},
