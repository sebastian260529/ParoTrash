...
fun PantallaCambiarDireccion(
    ...
    Column(
        ...
        Text(
            text = "Esta dirección se usará para tu ubicación o para la prestación de servicios.",
            fontSize = 14.sp,
        ...
        Column(
            ...
            Formulario(
                icon1 = Icons.Default.LocationOn,
                nombre = "Dirección nuevo",
                abajo = "",
                icon2 = false,
                usuario = "Dirección Nuevo",
                onTextChange = { }
            )
...
@Composable
fun PreviewPantallaCambiarDireccion() {
    ParoTrashTheme() {
        PantallaCambiarDireccion(
            irAHome = {},
            irAConfiguracion = {},
            irARegistroExitoso = {},
